window.onload = function(){
    ...
    let homeTyped = new Typed(".home-text",{
        strings:["안녕하세요","모션그래픽<br>디자이너 이수현입니다"],
        typeSpeed:100,
        cursorChar:"",
        loop:true,
        fadeOut:true
    ...
    for(let i = 0; i< workData.item_count; i++){
        ...
        <li class="swiper-slide">
                            <div class="pf-thumb">
                                <img src="https://img.youtube.com/vi/${obj.videoid}/maxresdefault.jpg" alt="썸네일">
                            </div>
                            <div class="pf-text">
                                <h2>${obj.tit}</h2>
                                <p>${obj.des}</p>
